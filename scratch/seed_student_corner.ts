...
async function main() {
  ...
  const committeeMembers = [
    ...
    { sNo: 2, name: "Dr. Ch. Srinivasa Rao", designation: "Professor of ECE & Coordinator, EDC", role: "Convener" },
    { sNo: 3, name: "Dr. G. Sraswathi", designation: "Professor of EEE", role: "Member" },
    { sNo: 4, name: "Sri K. Srinivasa Prasad", designation: "Assistant Professor of ME", role: "Member" },
    { sNo: 5, name: "Dr. B.Tirimula Rao", designation: "Assistant Professor of IT", role: "Member" }
  ];
  ...
  const activitiesList = [
    { sNo: 1, activity: "ENTREPRENEURSHIP AWARENESS PROGRAMMES", year: "2016-2017", date: "5,6 June 2016", theme: "ENTREPRENEURSHIP AWARENESS", participants: "600 students" },
    { sNo: 2, activity: "Start Reinvesting your own world", year: "2016-2017", date: "31st july,2016", theme: "Awareness", participants: "150 Students" },
    { sNo: 3, activity: "EXPLORING ENTREPRENEURSHIP OPPORTUNITIES IN AP", year: "2016-2017", date: "15,16 September, 2016", theme: "ENTREPRENEURSHIP OPPORTUNITIES", participants: "500 Students" },
    { sNo: 4, activity: "EXPLORING ENTREPRENEURSHIP OPPORTUNITIES IN AP", year: "2016-2017", date: "29,30 November 2016", theme: "ENTREPRENEURSHIP OPPORTUNITIES", participants: "350 Students" },
    { sNo: 5, activity: "Start Reinvesting your own world", year: "2016-2017", date: "3rd March 2017", theme: "Review Meeting", participants: "200 Students" },
    { sNo: 6, activity: "EXPLORING ENTREPRENEURSHIP OPPORTUNITIES IN AP", year: "2017-2018", date: "10,11 June 2017", theme: "ENTREPRENEURSHIP OPPORTUNITIES", participants: "400 Students" },
    { sNo: 7, activity: "Program on Sea Food Processing", year: "2017-2018", date: "23-26 November 2017", theme: "Awareness", participants: "350+ Students" },
    { sNo: 8, activity: "Start Reinvesting your own world", year: "2017-2018", date: "18th February 2018", theme: "Review Meeting", participants: "200 Students" },
    { sNo: 9, activity: "ENTREPRENEURSHIP AWARENESS PROGRAMMES", year: "2018-2019", date: "15,16 June 2018", theme: "ENTREPRENEURSHIP AWARENESS", participants: "600 Students" },
    { sNo: 10, activity: "EXPLORING ENTREPRENEURSHIP OPPORTUNITIES IN AP", year: "2018-2019", date: "26,27 December 2018", theme: "ENTREPRENEURSHIP OPPORTUNITIES", participants: "450 Students" }
  ];
  ...
  // 1. CSI
  const csiEvents = [
    { sNo: 1, title: "PHP and MYSQL Workshop", date: "13th Dec. 2014", details: "150 Students from CSE and IT branches" },
    { sNo: 2, title: "State Level Student Technical Paper Contest", date: "23rd Sept. 2014", details: "120 Students from Various Colleges" },
    { sNo: 3, title: "One Week Faculty Development Programme on Cyber Security", date: "11th -16th, June 2020", details: "320 Faculty members from different parts of the Country" },
    { sNo: 4, title: "Global Webinar Series on Cyber Security", date: "20th-26th, June 2020", details: "329 Participants from 18 Countries" },
    { sNo: 5, title: "One Week Online Workshop on Blended Learning", date: "06th -10th, July 2020.", details: "241 Participants from different parts of the Country" }
  ];
  await sql`
  ...
  // 2. IEEE
  const ieeeEvents = [
    { sNo: 1, title: "Poster Presentation Event in EclEctiquE 2K20", date: "11 February 2020", details: "Conducted in the Department of Electrical and Electronics Engineering in drawing Hall-1. Sri. Prasanna Kumar, Ms. Ch. Sravani (Assistant Engineers, Electrical Power Transmission and Distribution Company) invited as judges." }
  ];
  await sql`
    INSERT INTO prof_chapters (code, name, about, coordinator, faculty_members, events)
    VALUES (
  ...
  const ieEvents = [
    { sNo: 1, title: "Guest lecture: Analysis of Mechanical structures using FEM", date: "29-12-2015", details: "Delivered by Dr. J. Suresh Kumar under IE chapter" },
    { sNo: 2, title: "Guest lecture: Advancements in Vibration analysis", date: "14-09 -2017", details: "Delivered by Professor K. Meera Saheb, JNTUK Kakinada" },
    { sNo: 3, title: "Guest lecture: Long Span Bridges", date: "30-12-2017", details: "Delivered by Sri. A. Sai baba, Chief engineer, Indian railways" },
    { sNo: 4, title: "Guest lecture: WIND TURBINES AND ADVANCEMENTS IN MECHANICAL ENGINEERING", date: "11-10-2019", details: "Delivered by Lead engineer Sri. S.Sambamurthy from GE, Bangalore" },
    { sNo: 5, title: "Guest lecture: CONCEPTS OF COMPUTATIONAL FLUID DYNAMICS", date: "Delivered by Dr. M. Siva Subrahmanyam, Associate Professor, Department of ME, MVGRCE, Vizianagaram.", details: "Total number of students: 67" }
  ];
  await sql`
    INSERT INTO prof_chapters (code, name, about, coordinator, faculty_members, events)
    VALUES (
  ...
  // 4. IETE
  const ieteEvents = [
    { sNo: 1, title: "Symposia, Expo, Exhibitions & Workshops", date: "2019-2020", details: "JNTUK UCEV students (the department of ECE) conducted events like PROJECT EXPO, WORKSHOPS, EXHIBITIONS, and SEMINAR SYMPOSIA." }
  ];
  await sql`
    INSERT INTO prof_chapters (code, name, about, coordinator, faculty_members, events)
    VALUES (
  ...
  // 5. IIM
  const iimEvents = [
    { sNo: 1, title: "Hands on experience program (IIM Vizag Chapter)", date: "03rd August 2019", details: "Provides better practical knowledge for academically meritorious students studying B.Tech in Metallurgical Engineering at JNTUK-UCEV." },
    { sNo: 2, title: "One day National Conference on Innovations in Material Science & Technology", date: "12th December 2019", details: "National research conference hosted on campus." },
    { sNo: 3, title: "Opening of resource center in Metallurgical Engineering", date: "12th December 2019", details: "Inaugurated by Sri. K.K.Ghosh Director (Projects), RINL Visakhapatnam." },
    { sNo: 4, title: "EISEN2K20 National level technical symposium", date: "18th & 19th February 2020", details: "Two day symposium." },
    { sNo: 5, title: "EISEN2K19 National level technical symposium", date: "1st & 2nd March 2019", details: "Two day symposium." },
    { sNo: 6, title: "ACFAT17 National Workshop", date: "22nd August 2017", details: "Workshop on Advances in Composites and Ferro Alloy Technology." },
    { sNo: 7, title: "EISEN2K18 National level technical symposium", date: "20th & 21st February 2018", details: "Two day symposium." },
    { sNo: 8, title: "ICAMMP-2018 International Conference", date: "30th & 31st March 2018", details: "International Conference on Advanced Materials and Manufacturing Processes." },
    { sNo: 9, title: "National workshop on Fatigue, Fracture and Creep of Materials", date: "16th & 17th September 2016", details: "Fatigue, Fracture and Creep of Materials." },
    { sNo: 10, title: "National Metallurgist Day", date: "14th November 2016", details: "National level event celebrating metallurgy excellence." },
    { sNo: 11, title: "EISEN2K17 National level technical symposium", date: "09th & 10th March 2017", details: "Two day symposium." },
    { sNo: 12, title: "National Metallurgist Day", date: "14th November 2015", details: "Metallurgy celebrations." },
    { sNo: 13, title: "EISEN2K16 National level technical symposium", date: "01st & 2nd March 2016", details: "Two day symposium." }
  ];
  await sql`
    INSERT INTO prof_chapters (code, name, about, coordinator, faculty_members, events)
    VALUES (
  ...
  const iipcActivities = [
    { title: "Industrial Visits", details: "Regular visits organized to leading power plants, IT parks, and manufacturing facilities across the state." },
    { title: "Expert Guest Lectures", details: "Industrial veterans and senior directors share deep insights on emerging technologies, agile processes, and corporate expectations." },
    { title: "Joint MoUs & Training", details: "Active collaboration with top-tier companies to offer certified training programs, modern labs, and recruitment opportunities." }
  ];
