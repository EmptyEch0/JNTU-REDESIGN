...
async function main() {
  ...
  await db
    ...
    .set({
      image:
        "https://jntugvcev.edu.in/wp-content/uploads/2026/03/Prof.-K-C-B-Rao-Principal-1-1006x1024.jpeg",
    })
  ...
  await db
    .update(leadership)
    .set({
      image: "https://jntugvcev.edu.in/wp-content/uploads/2016/12/Dr-G-J-NAGA-RAJU-latest.jpg",
    })
