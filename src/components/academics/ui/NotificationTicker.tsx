...
export function NotificationTicker({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50/70 dark:from-slate-900/60 dark:to-slate-800/40 border border-blue-100 dark:border-slate-800/80 shadow-sm">
      ...
      {/* Scrolling track */}
      <div className="overflow-hidden py-3.5 pl-36 group/ticker">
        <div
          className="marquee-track group animate-marquee group-hover/ticker:[animation-play-state:paused] hover:[animation-play-state:paused]"
