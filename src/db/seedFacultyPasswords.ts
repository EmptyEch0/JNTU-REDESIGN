...
const FACULTY_CREDENTIALS: { facultyId: number; email: string; plainPassword: string }[] = [
  ...
  { facultyId: 215, email: "tirimula.rao.benala@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 216, email: "g.jaya.suma@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 217, email: "ch.bindu.madhuri@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 218, email: "g.madhavi@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 219, email: "w.anil@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 220, email: "rss.jyothi@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 221, email: "eswar.patnaala@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 222, email: "kolli.srikanth@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 223, email: "rajeti.roje.spandana@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 224, email: "pynam.venkateswarlu@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 225, email: "madhumita.chanda@jntugv.edu.in", plainPassword: "Faculty@2026" },
  { facultyId: 226, email: "bobbadi.manasa@jntugv.edu.in", plainPassword: "Faculty@2026" },
];
