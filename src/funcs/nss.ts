...
export const getNssProfile = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getNssActivities = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getNssSpecialCamp = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getNssGallery = createServerFn({ method: "GET" })
  .handler(async () => {
