...
import { weProfile, weCommittee, weActivities, weRecreation, weMagazine, weGallery } from "../db/schema";
import { eq, asc } from "drizzle-orm";

export const getWeProfile = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getWeCommittee = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getWeActivities = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getWeRecreation = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getWeMagazines = createServerFn({ method: "GET" })
  .handler(async () => {
...
export const getWeGallery = createServerFn({ method: "GET" })
  .handler(async () => {
