...
export const getPlacementHighlights = createServerFn({ method: 'GET' })
  .handler(async () => {
...
// TPO Functions
export const getTPO = createServerFn({ method: 'GET' })
  .handler(async () => {
...
export const getRecruiters = createServerFn({ method: 'GET' })
  .handler(async () => {
