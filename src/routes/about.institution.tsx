...
const HIGHLIGHTS = [
  ...
  {
    icon: Users,
    title: "1,450+ Students",
    desc: "Across 7 engineering disciplines and management",
  },
  {
    icon: BookOpen,
    title: "Est. 2007",
    desc: "Serving Andhra Pradesh's technological aspirations",
  },
      ...
      <section className="py-24 md:py-32 container-narrow grid lg:grid-cols-2 gap-16 items-start">
        ...
        <RevealOnScroll delay={150}>
          ...
          <div className="mt-6 space-y-4 text-muted-foreground text-lg leading-relaxed">
            <p>
              JNTU-GV College of Engineering Vizianagaram is one of the constituent Engineering
              Colleges of JNTU-GV playing a vital role in imparting Technological Education in the
              state of Andhra Pradesh since its establishment in the year 2007.
            </p>
            <p>
              The state-of-the-art campus is spread across 80 Acres in Dwarapudi panchayat at a
              distance of 8 KMs from Vizianagaram. It functions under the directions of Executive
              Council, Vice Chancellor and Registrar of JNTU-GV Vizianagaram.
            </p>
            <p>
              Principal is the executive head of the institution and Chairman of the College
              Academic Committee comprising all professors and heads of the departments. The Vice
              Principal, Heads of the departments and Members of College Academic Committee help in
              academic administration and effective functioning of the Institution.
            </p>
          </div>
        </RevealOnScroll>
      </section>
