...
const PERSONALITIES = [
  {
    name: "Dr. P.V.G. Raju",
    desc: "The Raja Saheb who renounced his Zamindari without compensation for the cause of education.",
  },
        ...
        <RevealOnScroll delay={150}>
          ...
          <div className="mt-6 space-y-4 text-muted-foreground text-lg leading-relaxed">
            <p>
              ...
              Pradesh in Southern India. An important centre for commerce and education, the city is
              located 18 km inland from the Bay of Bengal and 42 km to the northeast of
              Visakhapatnam. Vizianagaram translates to the "city of victory".
            </p>
            <p>
              It is, at present, the largest municipality of Andhra Pradesh in terms of population.
              As of 2011 Census of India, the town had a population of 227,533.
            </p>
            <p>
              The climate of Vizianagaram is characterized by high humidity nearly all the year
              round, with oppressive summers and good seasonal rainfall. The summer season extends
              from March to May, followed by the southwest monsoon season, which continues to
              September.
            </p>
          </div>
        </RevealOnScroll>
        ...
        <div className="container-narrow">
          <RevealOnScroll>
            <SectionLabel
              ...
              subtitle="Many luminaries have added new dimensions of glory to Vizianagaram."
              align="center"
            />
          </RevealOnScroll>
        ...
        <RevealOnScroll>
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-muted-foreground text-lg leading-relaxed">
              The Raja Saheb Dr. P.V.G. Raju who inherits the socialistic fervor and the spirit of
              religious tolerance from his ancestors renounced his Zamindari without taking any
              compensation and their fort is now entirely becoming the citadel of education which
              houses one of the oldest colleges — Maharaja College (1879) — in India.
            </p>
            <p className="mt-4 text-muted-foreground text-lg leading-relaxed">
              The talented musicians Dwaram Venkata Swami Naidu, Saluri Rajeswara Rao hail from this
              place. The divine singers Gantasala and Suseela who were the proud students of
              Maharaja College of Music added indescribable grace to the art of singing.
            </p>
          </div>
        </RevealOnScroll>
      </section>
        ...
        <div className="container-narrow">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-5">
            {[
              {
                title: "Roadways",
                desc: "APSRTC operates bus services from Vizianagaram to all major cities and towns in the state.",
              },
              {
                title: "Railways",
                desc: "Vizianagaram railway station is on the Khurda Road-Visakhapatnam section of Howrah-Chennai main line. Many important trains halt here.",
              },
              {
                title: "Airport",
                desc: "The nearest airport is in Visakhapatnam which is about 62 km from Vizianagaram.",
              },
            ].map((t, i) => (
