        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                    ...
                    <GlassCard 
                      className={`p-5 border-l-4 transition-all duration-300 cursor-pointer ${
                        activeTab === item.program 
                          ? "border-l-blue-600 bg-blue-50/20 dark:bg-blue-950/10" 
                          : "border-l-slate-300 dark:border-l-slate-700 hover:border-l-blue-500/50"
                      }`}
                      onClick={() => setActiveTab(item.program as any)}
                    >
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className={`w-5 h-5 mt-0.5 flex-shrink-0 transition-colors ${
                          activeTab === item.program ? "text-blue-600 dark:text-blue-400" : "text-slate-400"
                        }`} />
                            ...
                            {isEditMode && (
                              <div className="flex items-center gap-1 relative z-20">
                                ...
                                <button 
                                  ...
                                  className="p-1 hover:bg-red-100 dark:hover:bg-slate-700 text-red-600 rounded"
                                >
                                  <Trash2 size={10} />
                                </button>
                              </div>
              ...
              {/* Dynamic Brochure Download Card */}
              <GlassCard className="p-6 bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 text-white border-none shadow-xl relative overflow-hidden group">
                <div className="absolute right-0 top-0 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                <FileText className="w-8 h-8 text-blue-400 mb-4 animate-pulse" />
                ...
                <p className="text-[11px] text-slate-350 mb-6 leading-relaxed">
                  Download structured guidelines, eligibility criteria, and department listings dynamically curated for this academic session.
                </p>
                ...
                {isEditMode && editBrochureId !== null && (
                  <div className="p-4 bg-white/5 border border-amber-350/30 rounded-xl mb-4 space-y-2.5">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/10 border border-white/15 rounded-lg text-xs px-2.5 py-1.5 text-white outline-none" 
                    />
                    <input 
                      type="text" 
                    ...
                    <div key={brochure.id} className="relative group/brochure">
                      ...
                      >
                        <span className="flex items-center gap-2 text-left truncate pr-4">
                          <Download className="w-4 h-4 text-blue-400 group-hover/btn:scale-110 transition-transform flex-shrink-0" />
                          <span className="truncate">{brochure.title}</span>
                        </span>
                        <ChevronRight className="w-3.5 h-3.5 opacity-65 group-hover/btn:translate-x-1 transition-transform flex-shrink-0" />
                      </button>
