...
export const Route = createFileRoute("/administration/iqac/aqar")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Annual Quality Assurance Reports and Academic Audit Reports of JNTU-GV CEV." },
    ],
  }),
  component: AqarPage,
});
            ...
            <div>
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-base">Annual self-appraisal reports submitted to NAAC.</p>
                </div>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-muted/50 border-b border-border">
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground">AQAR Year</th>
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground text-right">Download</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    {isAqarLoading ? (
                      <tr><td colSpan={2} className="px-8 py-16 text-center text-muted-foreground animate-pulse">Loading reports...</td></tr>
                    ) : aqarReports?.map((report: any) => (
                      <tr key={report.id} className="group hover:bg-primary/[0.02] transition-colors">
            ...
            <div>
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-base">Periodic internal and external reviews of academic processes.</p>
                </div>
              </div>
              ...
              <div className="overflow-hidden rounded-[32px] border border-border bg-card/50 backdrop-blur-sm shadow-elegant">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-muted/50 border-b border-border">
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground">Audit Year</th>
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground text-right">Download</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    {isAuditLoading ? (
                      <tr><td colSpan={2} className="px-8 py-16 text-center text-muted-foreground animate-pulse">Loading audits...</td></tr>
