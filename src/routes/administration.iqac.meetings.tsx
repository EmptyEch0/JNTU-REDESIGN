...
export const Route = createFileRoute("/administration/iqac/meetings")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Outcomes, workshops, and faculty development programs organized by IQAC at JNTU-GV CEV." },
    ],
  }),
              ...
              <div>
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-base">Measurable impacts on institutional quality and performance.</p>
                  </div>
                </div>

                <div className="grid sm:grid-cols-2 gap-x-12 gap-y-6">
                  {isOutcomesLoading ? (
                    <div className="col-span-2 py-10 text-center text-muted-foreground animate-pulse">Loading outcomes...</div>
              ...
              <div className="bg-sand rounded-[40px] p-10 border border-border relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed italic">
                    "The IQAC serves as a catalyst for excellence, ensuring that our academic and administrative processes are continuously evolving to meet global standards."
                  </p>
                  <div className="pt-6 border-t border-border/50">
                    <div className="text-sm font-bold text-primary uppercase tracking-widest">Quality Assurance</div>
                    <div className="text-ink font-medium mt-1">JNTU-GV College of Engineering Vizianagaram</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-base">Empowering faculty and staff through continuous learning initiatives.</p>
                </div>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-muted/50 border-b border-border">
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground">S.No</th>
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground">Name of the Workshop/FDP</th>
                      <th className="px-8 py-5 text-xs font-bold uppercase tracking-wider text-muted-foreground text-right">Date</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    {isEventsLoading ? (
                      <tr><td colSpan={3} className="px-8 py-16 text-center text-muted-foreground animate-pulse">Loading events...</td></tr>
                    ) : events?.map((event: any, idx: number) => (
                      <tr key={event.id} className="group hover:bg-primary/[0.02] transition-colors">
                        <td className="px-8 py-6 text-sm font-medium text-muted-foreground">{idx + 1}</td>
