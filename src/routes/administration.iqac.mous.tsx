...
export const Route = createFileRoute("/administration/iqac/mous")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Institutional collaborations and strategic partnerships at JNTU-GV CEV." },
    ],
  }),
  component: MousPage,
});
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4 mb-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1 text-base">Strategic partnerships driving innovation and student placement.</p>
            </div>
          </div>

          <div className="space-y-16">
            {isLoading ? (
              <div className="py-20 text-center text-muted-foreground animate-pulse">Loading partnerships...</div>
            ) : mous?.map((mou: any) => (
              <div key={mou.id} className="group bg-card rounded-[48px] border border-border overflow-hidden shadow-elegant hover:shadow-2xl transition-all duration-700">
                  ...
                  <div className="grid lg:grid-cols-[1fr_300px] gap-16 items-start">
                    ...
                    <div className="space-y-8">
                      <div className="p-8 rounded-[32px] bg-muted/30 border border-border/50 space-y-6">
                        ...
                        <div className="space-y-4">
                          <div className="flex gap-3">
                            ...
                            <span className="text-sm text-muted-foreground font-medium">Blockchain Center of Excellence (BCoE)</span>
                          </div>
                          <div className="flex gap-3">
                            <div className="h-2 w-2 rounded-full bg-primary mt-2 shrink-0" />
                            <span className="text-sm text-muted-foreground font-medium">Industry-Academia Skill Development</span>
                          </div>
                          <div className="flex gap-3">
                            <div className="h-2 w-2 rounded-full bg-primary mt-2 shrink-0" />
                            <span className="text-sm text-muted-foreground font-medium">Student Internships & R&D</span>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center gap-4 px-6 text-muted-foreground">
                        ...
                        <span className="text-xs font-medium uppercase tracking-wider">Vizianagaram Campus</span>
                      </div>
                    </div>
                  </div>
                </div>
