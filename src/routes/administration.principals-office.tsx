...
export const Route = createFileRoute("/administration/principals-office")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Administrative support and functions of the Principal's Office at JNTU-GV CEV." },
    ],
  }),
...
const SERVICES = [
  { icon: FileText, title: "Certificates & Records", desc: "Processing of study certificates, bonafide certificates and student records." },
  { icon: Calendar, title: "Academic Scheduling", desc: "Management of college academic calendar and event coordination." },
  { icon: Users, title: "Public Relations", desc: "Handling external communications and institutional inquiries." },
  { icon: ClipboardCheck, title: "Compliance", desc: "Ensuring regulatory compliance and processing of official documentation." },
];
      ...
      <section className="py-24 md:py-32 container-narrow">
        <div className="max-w-4xl mx-auto text-center">
          <RevealOnScroll>
            ...
            <h2 className="text-display text-4xl text-ink">Streamlining administrative workflows</h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <div className="text-lg">Ground Floor, Administrative Block, JNTU-GV CEV Campus</div>
                  </div>
                </div>
                <div className="flex gap-5 items-start">
                  <div className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
