          ...
          <section key={subcat}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {list.map((item: any) => (
                <div
                  key={item.id}
                  className="group bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:border-amber-200 transition-all duration-500"
                >
                  ...
                  <p className="text-blue-600 text-xs font-bold uppercase tracking-tight mb-3">
                    {item.course}
                  </p>
