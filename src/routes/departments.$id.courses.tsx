      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-500 max-w-2xl text-base leading-relaxed">
            Explore our curriculum designed to meet industry standards and academic rigor. Select a
            program below to view the detailed regulation and syllabus.
          </p>
        </div>
                    ...
                    >
                      <div className="p-6">
                        ...
                        <p className="text-slate-500 text-sm leading-relaxed mb-5">
                          Comprehensive curriculum adhering to the latest university standards for{" "}
                          {course.name} under the {course.regulation} academic framework.
                        </p>
