  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dispensary at JNTU-GV CEV" },
      {
        ...
        content: "Doctor visits, common medicines and emergency response on campus.",
      },
    ],
  }),
...
const SERVICES = [
  {
    ...
    desc: "Visiting medical officer with scheduled hours.",
  },
  { icon: Pill, title: "Common Medicines", desc: "Essential medication for routine ailments." },
  {
    icon: Ambulance,
    title: "Emergency Referral",
    desc: "Rapid referral to partner hospitals in Vizianagaram.",
  },
...
function DispensaryPage() {
  return (
    <>
      <PageHero
        eyebrow="Dispensary"
        title="Care that meets you on campus."
        subtitle="A small, focused clinic for the everyday — and a swift response when something more is needed."
        image={cultureImg}
      />

      <section className="py-20 container-narrow">
        <RevealOnScroll>
          <SectionLabel eyebrow="Services" title="What we offer." />
        </RevealOnScroll>
      ...
      <section className="py-20 bg-sand">
        <div className="container-narrow">
          <RevealOnScroll>
            <SectionLabel eyebrow="Health Team" title="People who keep us well." align="center" />
          </RevealOnScroll>
          <div className="mt-12 grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
            <RevealOnScroll>
              <ProfileCard
                ...
                detail="First response, daily care and routine support for residents."
                badge="Care Team"
              />
            </RevealOnScroll>
            <RevealOnScroll delay={120}>
              <ProfileCard
                ...
                role="Health Assistant"
                detail="Coordinates wellness checks and clinic referrals."
                badge="Care Team"
              />
            </RevealOnScroll>
          </div>
