...
export const Route = createFileRoute("/placements/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Top recruiters, placement statistics and training at JNTU-GV CEV.",
      },
    ],
  }),
      ...
      <section className="py-20 container-narrow">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border rounded-3xl overflow-hidden border border-border shadow-[var(--shadow-elegant)]">
          <div className="bg-card p-8">
            <StatCounter value={latestStats.offers} label="Offers / Year" suffix="+" />
          </div>
          <div className="bg-card p-8">
            <StatCounter
          ...
          <div className="bg-card p-8">
            <StatCounter value={latestStats.recruiters} label="Recruiters" suffix="+" />
          </div>
          <div className="bg-card p-8">
            ...
            <RevealOnScroll delay={100}>
              <div className="relative">
                ...
                {isEditMode && editedTPO && (
                  <button
                    onClick={saveTPO}
                    className="mt-4 flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg font-bold text-sm"
                  >
        ...
        <div className="container-narrow">
          <RevealOnScroll>
            <SectionLabel
              ...
              title="Aim and Objectives of TPO"
              align="center"
            />
          </RevealOnScroll>
      ...
      <section className="py-20 bg-white">
        <div className="container-narrow">
          <RevealOnScroll>
            <SectionLabel
              eyebrow="Recruiters"
              title="A roster that keeps growing."
              align="center"
            />
          </RevealOnScroll>
          <div className="mt-12">
