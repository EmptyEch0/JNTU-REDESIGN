...
export const Route = createFileRoute("/sports")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Outdoor and indoor sports facilities, tournaments and a fitness culture on campus." },
  ...
  return (
    <>
      ...
      <section className="py-20 container-narrow">
        <RevealOnScroll>
          <img src={sportsImg} alt="Sports ground" loading="lazy" className="rounded-3xl aspect-[16/8] object-cover w-full shadow-[var(--shadow-elegant)]" />
        </RevealOnScroll>
      </section>

      <section className="py-16 container-narrow">
        <RevealOnScroll><SectionLabel eyebrow="On offer" title="Eight disciplines, one fitness culture." /></RevealOnScroll>
